        ...
        <div className={styles.nav }>
            <div className={styles.fullScreen} >
                <div className={styles.items}>
                    ...
                    <div className={styles.item} >
                        <NavLink className={({ isActive }) => isActive ? styles.isActive : styles.isPending} to={"/burger"} > <FontAwesomeIcon icon={faBurger} /><div className={styles.link} > Burger</div></NavLink>
                    </div>
                    <div className={styles.item} >
                        <NavLink className={({ isActive }) => isActive ? styles.isActive : styles.isPending} to={"/coldDrinks"}> <FontAwesomeIcon width={16} icon={faBottleWater} /><div className={styles.link} > Cold-Drinks</div></NavLink>
                    </div>
                    <div className={styles.item} >
                        <NavLink className={({ isActive }) => isActive ? styles.isActive : styles.isPending} to={"/hotDrinks"}> <FontAwesomeIcon icon={faMugHot} /> <div className={styles.link} > Hot-Drinks</div>   </NavLink>
                    </div>
                    <div className={styles.item} >
                        <NavLink className={({ isActive }) => isActive ? styles.isActive : styles.isPending} to={"/cartPage"}><FontAwesomeIcon icon={faCartShopping} /><div className={styles.link} >Cart</div></NavLink>
                    </div>
                </div>
            </div>
            <div className={styles.mobileDevice} >
                <div className={styles.items}>
                    ...
                    <div className={styles.item} >
                        <NavLink className={({ isActive }) => isActive ? styles.isActive : styles.isPending} to={"/burger"} ><FontAwesomeIcon icon={faBurger} /></NavLink>
                    </div>
                    <div className={styles.item} >
